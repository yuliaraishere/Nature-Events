                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../naev/naev-a.php">Nature Events</a>
                                <a class="nav-link" href="dino-a.php">Dinosaur Period</a>
                            </nav>
                        </div>
                        <div>
                                ...
                                <thead>
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <table id="datatablesSimple">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $result = mysqli_query($conn, "SELECT * FROM kelam2 ORDER BY id ASC");
                                                    ?>
                                                    <?php
                                                    $i = 1;
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            <td><?= $i ?></td>
                                                            <td><?= $data["Nama Dinosaurus"] ?></td>
                                                            <td><?= $data["Detail"] ?></td>
                                                            <td>
                                                                <img src="../../assets/images/<?= $data["Foto"]; ?>" width="90" alt="...">
                                                            </td>
                                                            <td>
                                                                <a href="dino-a.php?halaman=edit&id=<?= $data["id"]; ?>" class="btn btn-warning btn-sm">Edit</a>

                                                                <a href="dino-a.php?halaman=hapus&id=<?= $data["id"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('yakin dihapus')">Hapus</a>
                                                            </td>
                                                        </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <?php if (!isset($_GET["halaman"])) { ?>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <a href="dino-a.php?halaman=tambah" class="btn btn-primary">Add</a>
                                        </div>
                                    <?php } ?>
                                    </tbody>
                            </table>
