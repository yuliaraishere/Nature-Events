...
if(isset($_POST["save"])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO barang (category, request, note) VALUES ('$category', '$request', '$note')");
    ...
    if(isset($result)) {
        ...
        echo "<meta http-equiv='refresh' content='1;url=sub-list.php'>";
    } else {
...
function uploadImage() {
    ...
    (end($extension)); // mengambil text atau nama file paling belakang setelah dipecah (mengambil nama ekstensinya)
